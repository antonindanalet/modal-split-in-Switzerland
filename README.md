...
- by a user defined list of communes, with the example of the agglomeration of Zurich here.
...
### Run the code
Please copy the files etappen.csv, haushalte.csv and zielpersonen.csv of 2010 and 2015 that you receive from the Federal Statistical Office in the folders "data/input/2010/mtmc10" and "data/input/2015/mtmc15". Then run run_modal_split_in_Switzerland.py.
